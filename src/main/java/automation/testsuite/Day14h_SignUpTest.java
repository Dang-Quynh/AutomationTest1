...
public class Day14h_SignUpTest extends CommonBase {
    ...
    public void openChrome() throws InterruptedException {
        webDriver = initChromeDriver(CT_Common.URL_alada_signup);
    }
    ...
    public void signupSuccessfully_check_term() throws InterruptedException {
        ...
        Day14h_SignUpPageFactory signupPage = new Day14h_SignUpPageFactory(webDriver);
    ...
    public void signupFail_Name_Empty(){
        ...
        Assert.assertTrue(webDriver.findElement(Alada_CT_Account.SIGNUP_FAIL_NAME_EMPTY).isDisplayed());
    }
    ...
    public void signupFail_Email_Empty(){
        ...
        Assert.assertTrue(webDriver.findElement(Alada_CT_Account.SIGNUP_FAIL_EMAIL_EMPTY).isDisplayed());
    }
    ...
    public void signupFail_Incorrect_Email_Format(){
        ...
        Assert.assertTrue(webDriver.findElement(Alada_CT_Account.SIGNUP_FAIL_EMAIL_FORMAT).isDisplayed());
    }
    ...
    public void signupFail_ReEmail_Empty(){
        Day14h_SignUpPageFactory signupPage = new Day14h_SignUpPageFactory(webDriver);
        signupPage.signupFunction("quynh", "quynh@gmail.com", "", "123456", "123456", "0912345678");
        Assert.assertTrue(webDriver.findElement(Alada_CT_Account.SIGNUP_FAIL_ReEMAIL_EMPTY).isDisplayed());
    }
    ...
    public void signupFail_ReEmail_notEqual_Email(){
        ...
        Assert.assertTrue(webDriver.findElement(Alada_CT_Account.SIGNUP_FAIL_ReEMAIL_NotEQUAL_EMAIL).isDisplayed());
    }
    ...
    public void signupFail_Password_Empty(){
        ...
        Assert.assertTrue(webDriver.findElement(Alada_CT_Account.SIGNUP_FAIL_PASSWORD_EMPTY).isDisplayed());
    }
    ...
    public void signupFail_Incorrect_Password_Format(){
        ...
        Assert.assertTrue(webDriver.findElement(Alada_CT_Account.SIGNUP_FAIL_PASSWORD_FORMAT).isDisplayed());
    }
    ...
    public void signupFail_RePassword_Empty(){
        Day14h_SignUpPageFactory signupPage = new Day14h_SignUpPageFactory(webDriver);
        signupPage.signupFunction("quynh", "quynh@gmail.com", "quynh@gmail.com", "123456", "", "0912345678");
        Assert.assertTrue(webDriver.findElement(Alada_CT_Account.SIGNUP_FAIL_RePASSWORD_EMPTY).isDisplayed());
    }
    ...
    public void signupFail_Incorrect_RePassword_Format(){
        ...
        Assert.assertTrue(webDriver.findElement(Alada_CT_Account.SIGNUP_FAIL_RePASSWORD_FORMAT).isDisplayed());
    }
    ...
    public void signupFail_RePassword_notEqual_Password(){
        ...
        Assert.assertTrue(webDriver.findElement(Alada_CT_Account.SIGNUP_FAIL_RePASSWORD_NotEQUAL_PASSWORD).isDisplayed());
    }
    ...
    public void signupFail_Phone_Empty(){
        ...
        Assert.assertTrue(webDriver.findElement(Alada_CT_Account.SIGNUP_FAIL_PHONE_EMPTY).isDisplayed());
    }
    ...
    public void signupFail_Incorrect_Phone_Format(){
        ...
        Assert.assertTrue(webDriver.findElement(Alada_CT_Account.SIGNUP_FAIL_PHONE_FORMAT).isDisplayed());
    }
    ...
    public void signupFail_Incorrect_Phone_notNumber(){
        ...
        Assert.assertTrue(webDriver.findElement(Alada_CT_Account.SIGNUP_FAIL_PHONE_NotNUMBER).isDisplayed());
    }
    ...
    public void signupFail_Incorrect_Phone_Format_9number(){
        ...
        Assert.assertTrue(webDriver.findElement(Alada_CT_Account.SIGNUP_FAIL_PHONE_ERROR_LENGTH).isDisplayed());
    }
