...
public class Day15_Client extends CommonBase {
    ...
    private boolean checkAddClientSuccess(Day15_ClientModel client){
        boolean hasCompany = webDriver.findElement(By.xpath("//table[@id='client-table']//tr/td[2]/a[text()='"+ client.getCompany() +"']")).isDisplayed();
        boolean hasPhone = webDriver.findElement(By.xpath("//table[@id='client-table']//tr/td[4][text()='"+ client.getPhone() +"']")).isDisplayed();
    ...
    public void addClientSuccess() throws InterruptedException {
        ...
        Day15_AddClientPage addClientPage = new Day15_AddClientPage(webDriver);
