...
public class Day14_LoginTest extends CommonBase {
    ...
    public void openChrome() throws InterruptedException {
        webDriver = initChromeDriver(CT_Common.URL_rise_signin);
    }

    // thanh cong
    @Test
    public void loginSuccessfully(){
        LoginPageFactory loginPageFactory = new LoginPageFactory(webDriver);
    ...
    public void loginFail_emailFormatIncorrect(){
        ...
        Assert.assertTrue(webDriver.findElement(CT_Account.EMAIL_FORMAT_ERROR).isDisplayed());
    }
    ...
    public void loginFail_emailEmpty(){
        ...
        Assert.assertTrue(webDriver.findElement(CT_Account.EMAIL_EMPTY).isDisplayed());
    }
    ...
    public void loginFail_passwordEmpty(){
        ...
        Assert.assertTrue(webDriver.findElement(CT_Account.PASSWORD_EMPTY).isDisplayed());
    }
}
